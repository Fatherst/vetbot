...
EXPORT_API_USERNAME = os.getenv("EXPORT_API_USERNAME")
EXPORT_API_PASSWORD = os.getenv("EXPORT_API_PASSWORD")

START_DATE_YEAR = os.getenv("START_DATE_YEAR")
START_DATE_MONTH = os.getenv("START_DATE_MONTH")
START_DATE_DAY = os.getenv("START_DATE_DAY")
